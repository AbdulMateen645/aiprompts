...
function showPromptModal(prompt) {
    ...
    document.getElementById('modalContent').innerHTML = `
        ...
        <div class="flex gap-3 mt-6">
            <a href="/admin/prompts/${prompt.id}/edit" class="flex-1 px-4 py-2 bg-blue-600 text-white text-center font-semibold hover:bg-blue-700 transition-colors flex items-center justify-center gap-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                </svg>
                Edit Prompt
            </a>
            <button onclick="confirmDeletePrompt()" class="flex-1 px-4 py-2 bg-red-600 text-white font-semibold hover:bg-red-700 transition-colors flex items-center justify-center gap-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
